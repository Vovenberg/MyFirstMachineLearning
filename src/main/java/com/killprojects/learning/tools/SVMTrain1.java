package com.killprojects.learning.tools;

import com.killprojects.learning.SVMEngine;
...
class SVMTrain1
{
	...
	{
		System.out.print(
		 "Usage: SVMTrain1 [options] training_set_file [model_file]\n"
		+"options:\n"
		...
		+"-b probability_estimates : whether to train a SVC or SVR main for probability estimates, 0 or 1 (default 0)\n"
